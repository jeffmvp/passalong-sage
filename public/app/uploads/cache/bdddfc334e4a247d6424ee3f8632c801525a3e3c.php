      ...
      <div class="row">
        <div class="column column-50 TrackedGift-story">
          <div class="TrackedGift-container">
            <h1>Gift Tracking ID:<?php echo e(get_the_ID()); ?></br><span>Gift Tracking URL with Code: <?php the_permalink() ?>?code=<?php echo e($code); ?></span></h1>
            ...
            <?php echo $giftStartedWish; ?><br/><br/><br/>
