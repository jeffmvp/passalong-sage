 ...
 */
 add_editor_style(get_template_directory_uri() . '/assets/dist/styles.css');
    ...
    $styleFormats = array(
        array(
            ...
            'items' => array(
                ...
                array(
                    'title' => 'Button Inverted',
                    'block' => 'a',
                    'classes' => 'Button Button--inverted',
                    'wrapper' => true
                ),
                array(
                    'title' => 'Button Inverted Blue',
                    'block' => 'a',
                    'classes' => 'Button Button--invertedBlue',
                    'wrapper' => true
                )
            )
        ),
